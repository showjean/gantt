...
| `scroll_behavior`        | Determines the scroll behavior of [scrollTo()](https://developer.mozilla.org/ko/docs/Web/API/Window/scrollTo#behavior).| `smooth`, `instant`, `auto`                                                                                          | `smooth`                                            |
